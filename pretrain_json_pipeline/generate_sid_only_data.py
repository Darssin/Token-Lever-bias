...
Each row contains only sid sequences, without prompt template or system prompt.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate sid-only train/valid/test parquet files from user_sequence.txt and item_meta.with_sid.json."
    )
    ...
    parser.add_argument("--train_name", type=str, default="training_sid_only_data_train.parquet")
    parser.add_argument("--valid_name", type=str, default="training_sid_only_data_valid.parquet")
    parser.add_argument("--test_name", type=str, default="training_sid_only_data_test.parquet")
