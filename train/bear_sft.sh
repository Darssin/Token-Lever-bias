...
OUTPUT_DIR="/mnt/cfs/chubaofs_ads_train_image/ouchuang/bias/0.6B_bear_sft/"
USE_LORA=false

BEAR_WEIGHT=1.0
BEAR_TEMPERATURE=1.0
BEAR_BEAM_SIZE=10
...
nohup env WANDB_MODE=offline "${DEEPSPEED_CMD[@]}" 2>&1 | tee -a beauty_sid_rec_bear.log &
